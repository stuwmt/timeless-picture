...
public class GetImageListApi {
    ...
    public static void main(String[] args) {
        String imagePageUrl = GetImagePageUrlApi.getImagePageUrl("https://timeless-1329161178.cos.ap-shanghai.myqcloud.com/space/1882452446763110401/2025-01-26_pR5MOYLkMvDNZqSS_thumbnail.jpg");
        String url = GetImageFirstUrlApi.getImageFirstUrl(imagePageUrl);
